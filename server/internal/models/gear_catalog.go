...
const (
	...
	// ImageStatusAll is a special filter value (not stored in DB)
	// Used by admin to fetch all catalog records without curation-status filtering
	ImageStatusAll ImageStatus = "all"
)
